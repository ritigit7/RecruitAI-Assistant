...
class ExperienceItem(BaseModel):
    """Simplified experience item with fewer required fields"""
    ...
    technologies_used: Optional[List[str]] = Field(default=None, description="Technologies used")
...
class ClassifierInfo(BaseModel):
    ...
    subcategory: str = Field(description="The subcategory of the resume, if applicable.")
...
msg10='''You are a highly accurate and comprehensive resume title classifier AI assistant. Your task is to classify the resume into one of the following categories based on given json data.
Computer Science / IT / Software Engineering  - Software Engineering',Android Development',iOS Development',IT Support',
Data Science / AI / Machine Learning - Data Science',Artificial Intelligence',Machine Learning',
...
Marketing - Digital Marketing', Brand Marketing',
...
Legal / Law - Corporate Law', Litigation',
Graphic Design / UX/UI - Graphic Design',User Experience (UX)',User Interface (UI)',
Biomedical Science - Research',Clinical Trials',
Education / Teaching - Primary Education',Higher Education',
Psychology - Clinical Psychology',Research Psychology'
                '''
    ...
    try:
        ...
        for i, query in enumerate(msg):
            ...
            k_values = {
                ...
                3: 5,  # Education
                4: 6,  # Skills (spread throughout document)
                5: 4,  # Certifications
                6: 5,  # Projects (may be scattered)
                7: 4,  # Hobbies
                8: 4   # Achievements
            }
            ...
            messages=[
                {
                    "role": "system", 
                    "content": '''
                            You are a highly accurate and comprehensive resume title classifier AI assistant. Your task is to classify the resume into one of the following categories and indentify which subcategory is match the user data based on given json data.

                            'Computer Science / IT / Software Engineering  = subcategory {- Software Engineering',
                                                                           - Android Development',
                                                                           - iOS Development',
                                                                           - IT Support'}
                            'Data Science / AI / Machine Learning = subcategory{- Data Science',
                                                                  - Artificial Intelligence',
                                                                  - Machine Learning'}
                            'Electrical Engineering =  subcategory{- Power Systems',
                                                                - Electronics',}
                            'Mechanical Engineering = subcategory - Design',
                                                                     - Manufacturing',}
                            'Civil Engineering = subcategory {- Structural',
                                                             - Environmental'}
                            'Marketing = subcategory {- Digital Marketing', 
                                                         - Brand Marketing'}
                            'Finance = subcategory {- Investment Banking', 
                                                    - Financial Analysis'}
                            'Human Resources (HR) = subcategory {- Recruitment',
                                                                    - Employee Relations'}
                            'Sales = subcategory {- Business Development', 
                                                    - Account Management'}
                            'Business Administration = subcategory {- Management',
                                                                    - Operations'}
                            'Legal / Law = subcategory {- Corporate Law', 
                                                        - Litigation'}
                            'Graphic Design / UX/UI = subcategory {- Graphic Design',
                                                                - User Experience (UX)',
                                                                - User Interface (UI)'}
                            'Biomedical Science = subcategory {- Research',
                                                                - Clinical Trials'}
                            'Education / Teaching = subcategory {- Primary Education',
                                                                - Higher Education'}
                            'Psychology = subcategory {- Clinical Psychology',
                                                        - Research Psychology}
                '''},
...
INTERVIEWERS_FILE = "interviewers"
