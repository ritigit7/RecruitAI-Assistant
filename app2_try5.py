...
class ApplicationData(BaseModel):
    ...
    reference_details: List[ReferenceDetails]
...
msg1 = "Extract application form details, including the date, site, and the post applied for. These details are typically found at the beginning of the application form."
...
msg18 = "Extract all application data, including personal information, family details, education, work experience, references, certifications, general details, and technical interview information."
...
def fn_ApplicationData(userInput: str) -> ApplicationData:
    return get_llm_response(userInput,msg18, ApplicationData)
...
def fn_Resume(resume_text: str) -> list:
    ...
    try:
        ...
        sections = {
            ...
            "Application Data": fn_ApplicationData(results[17])
        }
...
if selected_page == "Resume Details":
    ...
    if uploaded_file is not None:
        ...
        if st.sidebar.button("Parse Resume"):
            ...
            with st.spinner("Extracting details of {data}"):
                try:
        ...
        if st.sidebar.button("Download Resume PDF"):
            ...
            with open('/home/ritik/Documents/VScode/AI_Resume_Meeting/resumes/professional_resume.pdf', "rb") as f:
